...
# Ввод ключевых слов и исключений для названия вакансии
...
# Ввод ключевых слов и исключений для описания вакансии
...
# Преобразование вводимых данных в списки
...
if st.button("Запустить поиск"):
    ...
    for keyword in title_keywords:
        ...
        while True:
            ...
            for vac in items:
                ...
                if any(k in title.lower() for k in title_keywords) and not any(ex in title.lower() for ex in title_exclude):
                    ...
                    # Объединяем текст описания вакансии
                    description = (vac.get("snippet") or {}).get("requirement", "") + " " + (vac.get("snippet") or {}).get("responsibility", "")
    ...
    if vacancies:
        ...
        df.drop_duplicates(subset="Ссылка HH", inplace=True)  # Удаляем дубли
